...
class _ChurchStaffTabState extends State<ChurchStaffTab> {
  ...
  final fdepartmentFocusNode = FocusNode();
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          ...
                                          autofocus: true,
                                          onEditingComplete: (){
                                            FocusScope.of(context).requestFocus(fdepartmentFocusNode);
                                          },
                                          onFieldSubmitted: (val){
                                            FocusScope.of(context).requestFocus(fdepartmentFocusNode);
                                          },
                                  ...
                                  SizedBox(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          focusNode: fdepartmentFocusNode,
                                          autofocus: true,
                                          onEditingComplete: (){
                                                    ...
                                                    InkWell(
                                                      onTap: () {
                                                        setState(() {
                                                          ...
                                                          permanentAddressController.text = churchStaffs[i].permanentAddress!;
                                                        });
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        width:size.width * 0.3,
                                        child: KText(
                                          text: churchStaff.permanentAddress!,
                                          style: TextStyle(
                                              fontSize:width/97.571
                                          ),
                                        ),
