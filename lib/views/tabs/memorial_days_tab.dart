...
class _RememberDaysTabState extends State<RememberDaysTab> with SingleTickerProviderStateMixin {
              ...
              builder: (ctx, snapshot) {
                if (snapshot.hasError) {
                  ...
                  snapshot.data!.docs.forEach((element) {
                    if(element.get("dod").toString().startsWith(DateFormat('dd-MM').format(DateTime.now()))){
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      onTap: () {
                                                        setState(() {
                                                          memberIdController.text = data.get("memberId");
                                                          nameController.text = data.get("name");
                                                          genderController.text = data.get("gender");
                                                          ageController.text = data.get("age");
                                                          dobController.text = data.get("dob");
                                                          dodController.text = data.get("dod");
                                                          descriptionController.text = data.get("description");
                                                        });
                                                        editPopUp(data.id,data.get("memberId") != "" ? true:false,size);
                                                      },
                                                      child: Container(
                                                        height: height/26.04,
                                                        decoration: BoxDecoration(
                                                    ...
                                                    InkWell(
                                                      onTap: () {
                                                        CoolAlert.show(
                                                            ...
                                                            text: "${data.get("name")} will be deleted",
                                                            ...
                                                            onConfirmBtnTap: () async {
                                                              cf.FirebaseFirestore.instance.collection('RememberDays').doc(data.id).delete();
                                                            }
                                                        );
                                                      },
                                                      child: Container(
  ...
  editPopUp(String id,bool isMember, Size size) {
    double height = MediaQuery.of(context).size.height;
    double width = MediaQuery.of(context).size.width;
    return showDialog(
      context: context,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () async {
                                    cf.FirebaseFirestore.instance.collection('RememberDays').doc(id).update({
                                      ...
                                      await CoolAlert.show(
                                          context: context,
                                          type: CoolAlertType.success,
                                          text: "Remember day updated successfully!",
                                          width: size.width * 0.4,
                                          backgroundColor: Constants()
                                              .primaryAppColor
                                              .withOpacity(0.8));
