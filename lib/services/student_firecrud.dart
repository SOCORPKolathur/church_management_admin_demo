  ...
  static Future<Response> bulkUploadStudent(Excel excel) async {
    ...
    for (int i = 1; i < row.length; i++) {
      ...
      StudentModel student = StudentModel(
        ...
        degree: row[i][17].toString(),
        instituteName: row[i][18].toString(),
        email: row[i][19].toString(),
        country: row[i][20].toString(),
        permanentAddress: row[i][21].toString(),
        resistentialAddress: row[i][21].toString(),
        // id: documentID,
        // studentId: row[i][1].toString(),
        // firstName: row[i][2].toString(),
        // lastName: row[i][3].toString(),
